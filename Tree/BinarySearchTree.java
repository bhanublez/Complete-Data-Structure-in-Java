public class BinarySearchTree<T extends Comparable<T>> {
    ...
    // This is used to form new node every time it called which is used to store
    // data and as an reference to that postion
    private class Node {
        T data;
        Node left, right;
    ...
    // Add an element to this binary tree . Return true if we successfully perform
    // an insertion
