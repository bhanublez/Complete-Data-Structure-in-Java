...
public class HashTableSeparateChanningLinkedList<K,V> implements Iterable<K>{
    ...
    //Converts a  hash value in an  index.Essentially , this strips the 
    //negative sign and places th hash value in the domain [0,capacity]
    ...
    //returns null if the value is null And also returns null if the key doses not exists so 
    public V get(K key){
    ...
    //Remove a key from the mao and returns the value
    //return null if null and is key not exists
